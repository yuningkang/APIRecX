...
class PretrainInputFeatures_1:
    """A single set of features of pre-training data.
    """
    def __init__(self, input_ids: List[int],word_index:List[int],project:str,tags:list):
...
def create_examples(args, tokenizer, mode='train'):
    ...
    if cached_features_file.exists():
        ...
        #     if len(features[i].input_ids) != 512:
        #         print(len(features[i].input_ids))
    else:
